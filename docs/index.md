...
<div style="flex:1; min-width:200px; background:#1e293b; border-radius:8px; padding:16px; border:1px solid #334155;">
<strong>GLM 실험적 확장 활성화를 통한 C++ 그래픽스 디버깅 환경 구축</strong><br><br>
...
<div style="flex:1; min-width:200px; background:#1e293b; border-radius:8px; padding:16px; border:1px solid #334155;">
<strong>스크린 공간에서의 원 판정(Point-in-Circle) 알고리즘 구현 및 최적화</strong><br><br>
...
<div style="flex:1; min-width:200px; background:#1e293b; border-radius:8px; padding:16px; border:1px solid #334155;">
<strong>광선-구체 교차 판정과 법선 벡터 계산의 수학적 구현</strong><br><br>
<a href="demos/광선-구체-교차-판정과-법선-벡터-계산의-수학적-구현/">데모 보기 →</a>
</div>

<div style="flex:1; min-width:200px; background:#1e293b; border-radius:8px; padding:16px; border:1px solid #334155;">
<strong>[리뷰] 레이트레이싱 기반 퐁 반사 모델(Phong Reflection Model)의 기초 구현</strong><br><br>
<a href="demos/리뷰-레이트레이싱-기반-퐁-반사-모델phong-reflection-mod/">데모 보기 →</a>
</div>

<div style="flex:1; min-width:200px; background:#1e293b; border-radius:8px; padding:16px; border:1px solid #334155;">
<strong>퐁 반사 모델(Phong Reflection Model)의 스펙큘러 하이라이트 및 반사 벡터 구현</strong><br><br>
...
<div style="flex:1; min-width:200px; background:#1e293b; border-radius:8px; padding:16px; border:1px solid #334155;">
<strong>벡터 외적을 이용한 삼각형의 법선 벡터 및 면적 계산</strong><br><br>
